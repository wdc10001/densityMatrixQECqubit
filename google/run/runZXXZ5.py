...
Q_Data = [Q1,Q2,Q4]
randomQubits = random.choice(Q_Data,random.choice(range(4),1),replace=False)
init_random = f'''
{X2P(randomQubits)}
{X2P(randomQubits)}
'''
...
if __name__ == '__main__':
    ...
    for ncycle in range(10,11):
        ...
        np.savetxt(f'google/result5/qubit_ncycle{ncycle+1}shots{shots}tH400pM0.03pCZ0.02pxyz0.01.txt',result,fmt='%d',delimiter='')
    pools.close()
    pools.join()
