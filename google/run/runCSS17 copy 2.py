...
qcis = ncycles*f'{ECM(nD,tH,tCZ,tM,tR)}'+f'{EC(tH,tCZ)}{M_ALL}'
...
if __name__ == '__main__':
    ...
    for ncycle in [ncycles]:
        ...
        np.savetxt(f'google/result/resultCSS17/qubit_initZ_ncycle{ncycle+1}shots{shots}tH400pM0.03pCZ0.02pxyz0.01.txt',result,fmt='%d',delimiter='')
    pools.close()
    pools.join()
