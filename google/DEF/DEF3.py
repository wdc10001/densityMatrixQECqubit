...
title = 'qubit_ncycle11shots40000pxyz0.01'
path = f'google/result3/{title}.txt'
CycleNum = 11
ExperimentNum = 40000
...
fig.update_layout(xaxis=dict(tickmode='linear',dtick=1),xaxis_title='cycle',yaxis_title='DEF',title=title+f'_qubit{ii}_std{round(DEF_std,4)}')
fig.show()